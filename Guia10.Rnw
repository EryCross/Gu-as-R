...
main="Gr?fico de caja por proceso", border=par("fg"), col=c("blue", "black", "purple"), xlab = 
...
main="Gr?fico de caja por proceso", border=par("fg"), col=c("bluen", "purple", "black"), xlab = 
"Duraci?n (semanas)", ylab="Proceso")
